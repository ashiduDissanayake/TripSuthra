...
export const Trendings = (): JSX.Element => {
  ...
  return (
    <div className="w-[1728px] h-[764px] bg-[#f7fbff] relative overflow-hidden">
      <div className="relative w-[1700px] h-[800px] -top-3 left-[40px] overflow-hidden">
        <img
        ...
        <div className="absolute top-[120px] left-0 inline-flex flex-col items-center gap-20">
          ...
          <div className="relative flex items-center overflow-hidden">
            ...
            <div className="flex gap-10">
              {displayItems.map((destination, index) => (
                <div 
                  key={index}
                  className="relative inline-flex h-[450px] items-center bg-[#ffffff] rounded-3xl shadow-drop-shadow-card"
                >
                  <div className="relative inline-flex flex-col items-start justify-center gap-12 p-10">
                    <div className="relative inline-flex flex-col items-start gap-6">
                      <p className="relative font-medium text-[#383838] text-[50px] tracking-[0] leading-[96px] whitespace-nowrap [font-family:'Poppins-Medium',Helvetica]">
                        <span className="text-[40px]">{destination.rating}</span> <span className="text-2xl leading-9">stars</span>
                      </p>
                      <div className="relative inline-flex items-start gap-1">
                        <img className="w-[21.1px] h-[20.14px]" alt="Star" src="star.svg" /> 
                        <img className="w-[21.1px] h-[20.14px]" alt="Star" src="star.svg" />
                        <img className="w-[21.1px] h-[20.14px]" alt="Star" src="star.svg" />
                        <img className="w-[21.1px] h-[20.14px]" alt="Star" src="star.svg" />
                        <img className="w-[21.1px] h-[20.14px]" alt="Star" src="star.svg" />
                    ...
                    <div className="relative flex flex-col gap-20">
                      <p className="relative w-[317px] font-normal text-[15px] text-[#282828] text-lg tracking-[0] leading-[27px] [font-family:'Poppins-Regular',Helvetica]">
                      ...
                      <div className="relative flex items-center gap-4">
                        ...
                        <A 
                          text="View In Map"
                          onClick={() => console.log('View In Map clicked')}
                          className="!h-[53px] !bg-[#087e8b] !w-[175px] "
                        />
                      </div>
                    </div>
                  </div>
