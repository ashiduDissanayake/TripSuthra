  ...
  return (
    <>
      <style>{`
        ...
        .name, .passport, .issuedate, .mobile {
          outline: none;
          border-radius: 20px;
        }
      ...
      <div className="container">
        ...
        <div className="login-form">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="issuedate" className="txt6">Passport Issue Date</label>
            <input className="issuedate" type="date" id="issuedate" name="issuedate" required />
            ...
            <div className="options-container">
              <label className="terms-label">
                <input type="checkbox" name="certified" /> I am a certified guide
              </label>
        ...
        <div className="image-section">
          <div className="image-container">
            <img src="/public/Girl.jpg" alt="Guide Scene" />
          </div>
        </div>
      </div>
    </>
